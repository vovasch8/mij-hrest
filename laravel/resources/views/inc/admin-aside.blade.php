<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar" style="">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link link-dark" href="{{route('admin-users')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                    Користувачі
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link link-dark" href="{{route('admin-forum')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bar-chart-2" aria-hidden="true"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                    Форум
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link link-dark" href="{{route('admin-albums')}}">
        ...
        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
            <span>Збережено</span>
            <a id="saveBlock" class="link-secondary" href="#" aria-label="Додати посилання" data-bs-toggle="modal" data-bs-target="#addSaveLinkModal">
        ...
        <ul class="nav flex-column mb-2">
            @foreach($links->where('id_block', 3) as $link)
                <li class="nav-item">
                    <a class="nav-link link-dark" href="{{$link->link}}">
...
@include('inc.modals.admin-save-modal')
